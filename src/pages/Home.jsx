...
function Home() {
  return (
    <>
      {/* landing */}
      <div style={{
        height: '100vh', backgroundImage: 'url("/Landing.png")',
        ...
        <div style={{ backgroundColor: 'rgba(0, 0, 0, 0.4)' }} className='w-50 p-5 rounded text-light text-center'>
          ...
          <Link to={"/resume"} style={{ backgroundColor: "#b88662" }} className="btn text-light mt-3">Make your Resume With AI</Link>
        </div>
      </div>
      {/* about */}
      <div className='container my-5'>
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-5">
            <img width={'100%'} height={'500px'} src="/resume.png" alt="resume"></img>
          </div>
        </div>
      </div>
      {/* banner */}
       <div style={{
        height: '80vh', backgroundImage: 'url("/team.png")',
        backgroundSize: 'cover', backgroundAttachment: 'fixed'
      }}> </div>
      {/* testimony */}
      <div className='container my-5'>
          ...
          <div className="col-lg-5">
            <div className='row'>
              <div className="col-md-3">
                <img className='img-fluid p-2' src='/team.png'></img>
              </div>
               <div className="col-md-3">
                <img className='img-fluid p-2' src='/team.png'></img>
              </div>
